...
public class MethoedCall {
    ...
    public String methodCaller(String caller) {
        ...
        switch (methname) {
            ...
            case "result":{
                String x = sr.getValueFromArray(caller, 1);
                String y = sr.getValueFromArray(caller, 2);
                float z = Float.parseFloat(sr.getValueFromArray(caller, 3));
                result = sm.result(x, y,z);
                break;
            }
