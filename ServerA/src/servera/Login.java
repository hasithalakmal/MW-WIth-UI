...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Port Number to Run");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtPortnum, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            int pn = Integer.parseInt(txtPortnum.getText());
            bool1=true;
            while (bool1) {
               // taServerLog.setText("Server is runnung...");
                ServerSocketConfig ssc = new ServerSocketConfig();
                ssc.runserver5(pn);
            }
           // taServerLog.setText("Server Stop!!!");
            System.out.println("Server Stop!!!");
        }catch(Exception e){
          //  taServerLog.setText("Enter a correct port number to run server...");
        }
